package com.curso.android.controlpers;
...
public class ExtendedEdit2 extends EditText {
	
	private Paint p1;
	private Paint p2;
	private float escala;
	
	public ExtendedEdit2(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		// TODO Auto-generated constructor stub
		inicializacion();
	}
	
	public ExtendedEdit2(Context context, AttributeSet attrs) {
		super(context, attrs);
		// TODO Auto-generated constructor stub
		inicializacion();
	}
	
	public ExtendedEdit2(Context context) {
		super(context);
		// TODO Auto-generated constructor stub
		inicializacion();
	}
